...
- pick one correct and one incorrect test example (from different classes) and generate shap maps (`correct_case_shap.png`, `incorrect_case_shap.png`).
- interpretation tips:
...
- include test accuracy, roc auc, and the confusion matrix.
